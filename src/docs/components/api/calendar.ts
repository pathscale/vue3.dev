const api =
  [
    {
      title: 'VCalendar',
      github: 'https://github.com/pathscale/vue3-ui/blob/master/src/components/primitives/Calendar/Calendar.vue',
      props: [
        {
          name: 'v-model',
      ...
      events: [
        {
          name: 'select',
          description: 'Triggered when start / end date is selected, but not yet validated and saved',

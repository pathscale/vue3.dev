const api = [
  {
    title: "VAccordion",
    github:
      "https://github.com/pathscale/vue3-ui/blob/master/src/components/compounds/Accordion/Accordion.vue",
    props: [
      {
        name: "is-horizontal",
        type: "boolean",
  ...
  },
  {
    ...
    github:
      "https://github.com/pathscale/vue3-ui/blob/master/src/components/compounds/Accordion/AccordionMenu.vue",
    slots: [
      {
        name: "label",

const api = [
  {
    title: "VBreadcrumb",
    github:
      "https://github.com/pathscale/vue3-ui/blob/master/src/components/compounds/Breadcrumb/Breadcrumb.vue",
    props: [
      {
        name: "alignment",
      ...
      },
      {
        ...
        type: "String",
        values:
          "has-arrow-separator, has-bullet-separator, has-dot-separator and has-succeeds-separator",
      },
    ],
  },
  {
    ...
    github:
      "https://github.com/pathscale/vue3-ui/blob/master/src/components/compounds/Breadcrumb/BreadcrumbItem.vue",
    props: [
      {
        name: "tag",

const api = [
	{
		title: "VSelect",
		github:
			"https://github.com/pathscale/vue3-ui/blob/master/src/components/primitives/Select/Select.vue",
		props: [
			{
				name: "v-model",
			...
			},
			{
				name: "placeholder",
				description:
					"Specifies a short hint that describes the expected value of the input field. Only displayed when the binding value is null",
				type: "String",
			},
			{
				name: "multiple",

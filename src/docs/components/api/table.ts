const api = [
  {
    title: "VTable",
    github:
      "https://github.com/pathscale/vue3-ui/blob/master/src/components/compounds/Table/Table.vue",
    props: [
      {
        name: "data",
        description:
          "Configuration object where rows and columns are registered",
        type: "Object",
      ...
      },
      {
        name: "searchable",
        description:
          "Allows the table to display search inputs for every column",
        type: "Boolean",
      },
      {
        name: "checkable",
        description:
          "Configures the table to display checking boxes to select a set of rows",
        type: "Boolean",
      },
      {
        name: "pagination",
      ...
      },
      {
        name: "fullwidth",
        description:
          "The table will take the full width of its parent component",
        type: "Boolean",
      },
      {
        name: "has-reset-btn",
        description:
          "The table will show a button that will reset all configurations",
        type: "Boolean",
      },
      {
        name: "sortable",
      ...
      },
      {
        name: "expandable",
        description:
          "Rows will be expandable, a slot named expanded is available for custom expanded content",
        type: "Boolean",
      },
      {
        name: "draggable-rows",
      ...
      },
      {
        name: "group-by",
        description:
          "Rows will be shown in groups of common values for a given column",
        type: "String",

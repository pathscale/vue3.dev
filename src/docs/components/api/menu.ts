const api = [
  {
    title: "VMenu",
    github:
      "https://github.com/pathscale/vue3-ui/blob/master/src/components/compounds/Menu/Menu.vue",
    slots: [
      {
        name: "default",
  ...
  },
  {
    title: "VMenuItem",
    github:
      "https://github.com/pathscale/vue3-ui/blob/master/src/components/compounds/Menu/MenuItem.vue",
    props: [
      {
        name: "label",
      ...
      },
      {
        name: "aria-role",
        description:
          "Role attribute to be passed to list item for better accessibility. Use menuitem only in situations where your menu item is really related to navigation.",
        type: "String",
        values: "menuitem",
      },
      {

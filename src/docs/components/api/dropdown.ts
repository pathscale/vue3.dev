const api = [
	{
		title: "VDropdown",
		github:
			"https://github.com/pathscale/vue3-ui/blob/master/src/components/compounds/Dropdown/Dropdown.vue",
		props: [
			{
				name: "v-model",
			...
			},
			{
				...
				type: "String",
				values: "is-left, is-up, is-down, is-right",
			},
			{
				name: "disabled",
			...
			},
			{
				name: "aria-role",
				description:
					"Role attribute to be passed to list container for better accessibility.",
				type: "String",
		...
		events: [
			...
			},
			{
				name: "active-change",
				description:
					"Triggers when dropdown is activated or deactivated (visibility of list)",
	...
	},
	{
		title: "VDropdownItem",
		github:
			"https://github.com/pathscale/vue3-ui/blob/master/src/components/compounds/Dropdown/DropdownItem.vue",
		props: [
			{
				name: "value",
			...
			},
			{
				name: "aria-role",
				description:
					"Role attribute to be passed to list item for better accessibility",
				type: "String",

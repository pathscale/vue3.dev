      ...
      methods: [
        {
          ...
          description: 'Adds a column to the grid',
				},
				{
					...
					description: 'Adds a row to the grid, the index parameter is optional, only use it when you want to insert a row at a custom index'
				},
				{
				...
				},
				{
					...
					description: 'Returns an object that maps column names to column instances'
				},
				{

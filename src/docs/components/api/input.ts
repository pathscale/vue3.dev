const api = [
  {
    title: "VInput",
    github:
      "https://github.com/pathscale/vue3-ui/blob/master/src/components/primitives/Input/Input.vue",
    props: [
      {
        name: "v-model",
      ...
      },
      {
        name: "type",
        description:
          "The input can be displayed in several ways, depending on the type attribute.",
        type: "String",

...
<template>
  <section>
    <h4 class="is-size-5 mb-4">Table with custom header and footer</h4>
    ...
    <h4 class="is-size-5 mb-4 mt-6">Table with custom component</h4>
    <v-table :data="datagrid" is-fullwidth>
    ...
    <h4 class="is-size-5 mb-4 mt-6">Table with expandable rows</h4>

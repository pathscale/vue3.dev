...
import api from 'src/docs/components/api/checkbox.ts'

import Showcase from 'src/docs/components/showcases/Checkbox.vue'
import ShowcaseCode from 'src/docs/components/raw/Checkbox.txt'

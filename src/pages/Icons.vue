  ...
  <div>
    ...
    <v-tabs v-model="activeTab" type="is-boxed" class="mt-4">
      ...
      <v-tab label="Icons.vue">
        <div class="box is-family-code">
          <i class=" has-text-grey-light">Register here all icons you want to use in your app indicating once the icon's
            src (from your assets or our icon sets)</i>
          <br />
          &lt;template>
          ...
          <br />&nbsp;&lt;v-icon src="@pathscale/vue3-svg-icons/devicon/bower/bower-original-wordmark.svg
          name="bower-icon" bundle="icons"/>
    ...
    <p class="mt-4">
      Checkout <a href="https://github.com/pathscale/vue3-svg-icons" target="_blank" rel="noopener">here</a> all
      available icons sets
    </p>

    <snippet-section title="Sizes" :code="SizesCode" :component="Showcases.IconSizes"
      :path="router.currentRoute.value.path" />
    <snippet-section title="Colors" :code="ColorsCode" :component="Showcases.IconColors"
      :path="router.currentRoute.value.path" />
    <snippet-section title="Custom Sizes" :code="CustomSizesCode" :component="Showcases.IconCustomSizes"
      :path="router.currentRoute.value.path" />
    <snippet-section title="Custom Class" :code="CustomClassCode" :component="Showcases.IconCustomClass"
      :path="router.currentRoute.value.path" />

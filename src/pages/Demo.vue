  ...
  <section class="has-background-white pt-6">
    <v-columns class="pt-5 mx-0">
      ...
      <v-column class="pt-6">
        ...
        <br />
        <v-card style="width:80%;" class="mt-3">
          <v-card-content>            
            <div>
              Hah! I bet you expected some fancy demo, but actually all of vue3.dev is built on vue3-ui, including the samples.  
              <br /><br />
              Please go check those out <a href="https://vue3.dev/">@vue3-ui</a>.
            </div>
          </v-card-content>          
        </v-card>
      </v-column>

        ...
        children: [
          {
            ...
            meta: metaTags(
              "Playground",
              "Cleanroom for develop and component testing",
            ),
          },
          {
            name: "installation",
            ...
            meta: metaTags(
              "Installation",
              "Install vue3-ui, a vue3 ready components library",
            ),
          },
          {
            name: "introducing",
          ...
          },
          {
            ...
            meta: metaTags(
              "Theming",
              "Customize Vue3-ui and make it your own.",
            ),
          },
          {
            name: "colors",
          ...
          },
          {
            ...
            meta: metaTags(
              "Icons",
              "Mega compilation of svg icons optimized for fast delivery",
            ),
          },
          {
            name: "button",
          ...
          },
          {
            ...
            meta: metaTags(
              "Checkbox",
              "Display a toggling box to keep your on / off states",
            ),
          },
          {
            name: "upload",
          ...
          },
          {
            ...
            meta: metaTags(
              "Validation",
              "Usage of validators with vue3-ui form components",
            ),
          },
          {
            name: "breadcrumb",
          ...
          },
          {
            ...
            meta: metaTags(
              "Accordion",
              "Expansion panel that saves screen space",
            ),
          },
          {
            name: "toast",
...
router.beforeEach((to, _from, next) => {
  ...
  const metaTags = nearestWithMeta.meta.metaTags.map((tagDef) => {
